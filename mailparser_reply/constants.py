...
MAIL_LANGUAGES: Dict[str, Dict[str, str]] = {
    ...
    "ja": {
        # Optimized: simplified pattern for better performance and reliability
        "wrote_header": r"^("
        + QUOTED_MATCH_INCLUDE
    ...
    "zh": {
        # Optimized: simplified pattern without problematic negative lookahead
        "wrote_header": r"^("
        + QUOTED_MATCH_INCLUDE
